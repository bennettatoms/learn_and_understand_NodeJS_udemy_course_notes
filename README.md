##Notes for the Udemy course [Learn and Understand NodeJS](https://www.udemy.com/understand-nodejs/#/) by Antony Alicea
...
Endpoint - the URL itself (one URL in a web API)
